            ...
            <div className="flex-grow container mx-auto px-4 py-8 relative">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <main className="flex-1 min-w-0">
                        <div className="mb-8">
                            <Badge className="bg-blue-600 mb-2 hover:bg-blue-700">ETF Course</Badge>
                            <h1 className="text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 mb-4">
                                Сессия 1: Основы ProTrader Systems
                            </h1>
                            <p className="text-xl text-gray-400">
                                Полное руководство по началу работы с системой ETF и базовыми понятиями трейдинга.
                            </p>
                        </div>
                        ...
                        <div className="mt-16 flex justify-between items-center pt-8 border-t border-gray-800">
                            <div className="text-gray-400 text-sm">
                                Просмотрено {session1Content.length} из {session1Content.length} разделов
                            </div>
