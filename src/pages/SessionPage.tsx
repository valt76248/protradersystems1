...
const SESSION_DATA: Record<string, any[]> = {
    'session-1': session1Content,
    'session-2': session2Content
};
...
const SessionPage = () => {
    ...
    const content = SESSION_DATA[sessionId || 'session-1'] || session1Content;
    ...
    const sessionKey = sessionId === 'session-2' ? 'session2' : 'session1';
            ...
            <div className="flex-grow container mx-auto px-4 py-8 relative">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <main className="flex-1 min-w-0">
                        <div className="mb-8">
                            <Badge className="bg-blue-600 mb-2 hover:bg-blue-700">{t(`${sessionKey}.badge`)}</Badge>
                        ...
                        <div className="mt-16 flex justify-between items-center pt-8 border-t border-gray-800">
                            <div className="text-gray-400 text-sm">
                                {t('session.viewed')} {content.length} {t('session.of')} {content.length} {t('session.sections')}
                            </div>
