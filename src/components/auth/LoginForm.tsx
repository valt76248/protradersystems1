    ...
    <Card className="bg-trading-card border-gray-800 w-full max-w-md shadow-2xl overflow-hidden">
      ...
      <CardContent>
        ...
        <div className="space-y-4">
          <div className="p-3 rounded-lg bg-trading-accent/5 border border-trading-accent/20 flex items-start gap-3">
            <Lock className="h-5 w-5 text-trading-accent mt-0.5" />
            <div>
              <p className="text-xs font-semibold text-trading-accent uppercase tracking-wider">Secure Node Access</p>
              <p className="text-[11px] text-gray-400 mt-1 leading-relaxed">
                Вы входите в защищенное пространство. Ваши учетные данные зашифрованы с использованием алгоритма
                <span className="text-white font-mono mx-1">PBKDF2</span>
                (100k итераций) и защищены JWT-токенами промышленного стандарта.
              </p>
            </div>
          </div>
