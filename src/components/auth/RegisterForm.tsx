      ...
      <CardContent className="space-y-4 p-6 pt-0">
        ...
        <div className="space-y-4">
          <div className="p-3 rounded-lg bg-emerald-500/5 border border-emerald-500/20 flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-semibold text-emerald-500 uppercase tracking-wider">Exclusive Environment</p>
              <p className="text-[11px] text-gray-400 mt-1 leading-relaxed">
                Вы регистрируете доступ в высокотехнологичную экосистему. Ваши данные защищены по протоколам
                <span className="text-white font-mono mx-1">Military-grade</span>
                шифрования. Мы гарантируем конфиденциальность и отсутствие передачи данных третьим лицам.
              </p>
            </div>
          </div>
